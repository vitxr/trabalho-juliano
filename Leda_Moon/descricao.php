...
<div id="sidebar" class="span3">
	...
	<div class="row-fluid">
			...
			<div class="span7">
				<h3><?php echo utf8_encode( $Nome_pro )?></h3>
				<hr class="soft"/>
				...
				<form class="form-horizontal qtyFrm">
				 ...
				 <br />
				 <a href="carrinho.php?acao=add&Cod_pro=<?php echo $dado['Cod_pro'] ?>" class="addCarrinho"> Adicionar ao Carrinho </a>
				</form>
			</div>
			</div>
				<hr class="softn clr"/>
           <ul id="productDetail" class="nav nav-tabs">
            ...
            <div class="tab-pane fade active in" id="home">
			  <h4>Informações do Produto</h4>
				...
				<p><?php echo utf8_encode($Descr_pro)  ?></p>
